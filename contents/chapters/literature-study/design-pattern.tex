...
\begin{figure}[h]
    \centering
    %TODO-DESIGN \includegraphics[width=\textwidth]{\dir/include/bread-model.png}
...
In actual user's view, simple interaction and interface can use \ac{SPA}\index{SPA}\index{single page application} approach as the client app view.
