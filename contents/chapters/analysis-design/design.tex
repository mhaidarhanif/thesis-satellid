...
The application main interface or \ac{UI} design is laid out very simple with \ac{SPA} model/design, just like in \autoref{fig:satellid-app-ui}, including some mockups or example.
...
As seen in \autoref{fig:satellid-app-ui}, the \ac{UI} design is really straightforward.
...
\begin{figure}[htb]
  ...
  \caption{Initial user interface design of Satellid app}
  \label{fig:satellid-app-ui}
\end{figure}

\begin{figure}[htb]
  \centering
  \includegraphics[width=15cm]{\dir/include/satellid-app-ux.png}
