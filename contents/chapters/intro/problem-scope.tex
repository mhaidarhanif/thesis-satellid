...
The tools which being used are a NoSQL document database called MongoDB, JavaScript programming language and related, JSON data format, Node.js platform, full-stack framework named Meteor with testing framework named Velocity, and source code management with Git.
